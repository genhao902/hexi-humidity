...
# Simple and convenient path: Save to 'data' folder in the project root
...
def hourly_to_monthly(df):
    ...
    return monthly[[
        "city","year","month",
        "temperature_mean","pressure_mean","wind_speed_mean",
...
output_path = os.path.join(DATA_DIR, "hexi_monthly_clean.csv")
