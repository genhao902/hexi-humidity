...
# relplot with col="year" creates one sub-panel per year (facet grid).
# sharey=False lets each panel use its own y-axis scale, so year-to-year
# differences in absolute humidity don't compress the curves.
...
# Correlation heatmap
# Select only numeric meteorological columns before computing correlation.
# .corr() defaults to Pearson, measuring linear relationships between features.
